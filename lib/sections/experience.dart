...
class ExperienceWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child:
          Column(children: person.jobs.map((job) => JobWidget(job)).toList()),
    );
  }
}
          ...
          child: Wrap(
            children: [
              ...
              ...job.positions
                  .asMap()
                  .entries
                  .map((entry) => PositionWidget(entry.value, entry.key))
                  .toList()
            ],
          ),
        ),
        ...
        SizedBox(
          ...
          child: Wrap(
              ...
              children: job.keywords
                  .map((keyword) => KeywordsWidget(keyword))
                  .toList()),
        ),
        Column(
            children: job.responsibilitys
                .map((responsibility) => ResponsibilityWidget(responsibility))
                .toList()),
      ]),
    );
  }
